...
<p>jQuery 加载方式:</p>
<p><label><input type="radio" id="jquery_1" name="jquery_mode" value="1" /> 从 Google API 提供的 CDN 加载 </label></p>
<p><label><input type="radio" id="jquery_2" name="jquery_mode" value="2" /> 从 Sina App Engine 提供的 CDN 加载 (默认,推荐)</label></p>
